...
@NgModule({
  ...
  exports: [ContentModule, FooterModule, HeaderModule, SidebarLeftModule, SidebarRightModule, WrapperModule,  NotificationsDropdownMenuModule, MessagesDropdownMenuModule],
