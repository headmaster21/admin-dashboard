  ...
  children: [
    {
      ...
      children: [
        {
          path: 'box',
          loadChildren:  () => import('./components/+boxs/box-default/box-default.module').then(m => m.BoxDefaultModule),
          data: {
            title: 'Box'
          }
        }, {
          path: 'info-box',
          loadChildren:  () => import('./components/+boxs/box-info/box-info.module').then(m => m.BoxInfoModule),
          data: {
            title: 'Info Box'
          }
        }, {
          path: 'small-box',
          loadChildren:  () => import('./components/+boxs/box-small/box-small.module').then(m => m.BoxSmallModule),
          data: {
            title: 'Small Box'
          }
        }
        ...
        path: 'dropdown',
        loadChildren:  () => import('./components/+dropdown/dropdown.module').then(m => m.DropdownModule),
        data: {
          title: 'Dropdown',
        }
      }, {
    ...
    children: [
      {
        path: 'input-text',
        loadChildren:  () => import('./components/+form/input-text/input-text.module').then( m => m.InputTextModule),
        data: {
          title: 'Input Text',
        }
      }
